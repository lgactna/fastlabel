...
class ComputerSpecification(observable.ObservableObject):
    """
...
class WindowsHandle(observable.ObservableObject):
    """
...
class EmailAddress(observable.DigitalAddress):
    """
...
class Tweet(observable.Message):
    """
...
class UNIXFile(observable.File):
    """
    A UNIX file is a file pertaining to the UNIX operating system.
    """


class X509V3Certificate(observable.ObservableObject):
    """
...
class MACAddress(observable.DigitalAddress):
    """
...
class WindowsService(observable.ObservableObject):
    """
...
class SQLiteBlob(observable.ObservableObject):
    """
...
class Disk(observable.ObservableObject):
    """
...
class WindowsHook(observable.ObservableObject):
    """
...
class NetworkRoute(observable.ObservableObject):
    """
...
class Image(observable.ObservableObject):
    """
    An image is a complete copy of a hard disk, memory, or other digital media.
    """


class ProtocolConverter(observable.Device):
    """
...
class DigitalAccount(observable.Account):
    """
...
class IPhone(observable.AppleDevice):
    """
    An iPhone is a smart phone that applies the iOS mobile operating system.
    """


class ForumPrivateMessage(observable.Message):
    """
...
class Directory(observable.FileSystemObject):
    """
...
class GUI(observable.ObservableObject):
    """
...
class BluetoothAddressFacet(observable.MACAddressFacet):
    """
...
class ObservablePattern(observable.Observable):
    """
...
class TableField(observable.ObservableObject):
    """
...
class SIPAddressFacet(observable.DigitalAddressFacet):
    """
...
class ContactList(observable.ObservableObject):
    """
...
class WindowsWaitableTime(observable.ObservableObject):
    """
...
class Application(observable.ObservableObject):
    """
...
class EventRecord(observable.ObservableObject):
    """
...
class InstantMessagingAddressFacet(observable.DigitalAddressFacet):
    """
...
class BlackberryPhone(observable.SmartPhone):
    """
...
class WindowsCriticalSection(observable.ObservableObject):
    """
...
class Pipe(observable.ObservableObject):
    """
...
class MessageThread(observable.ObservableObject):
    """
...
class SendControlCodeEffectFacet(observable.DefinedEffectFacet):
    """
...
class X509Certificate(observable.ObservableObject):
    """
...
class ContentData(observable.ObservableObject):
    """
...
class EmailAddressFacet(observable.DigitalAddressFacet):
    """
...
class ArchiveFile(observable.File):
    """
...
class DomainName(observable.ObservableObject):
    """
...
class Library(observable.ObservableObject):
    """
...
class StateChangeEffectFacet(observable.DefinedEffectFacet):
    """
...
class WindowsThread(observable.ProcessThread):
    """
    A Windows thread is a single thread of execution within a Windows process.
    """


class WhoisContactFacet(observable.ContactFacet):
    """
...
class EmailAccount(observable.DigitalAccount):
    """
...
class NetworkFlow(observable.ObservableObject):
    """
...
class API(observable.ObservableObject):
    """
...
class Appliance(observable.Device):
    """
...
class UNIXAccount(observable.DigitalAccount):
    """
    A UNIX account is an account on a UNIX operating system.
    """


class RecoveredObject(observable.ObservableObject):
    """
...
class WindowsTask(observable.ObservableObject):
    """
...
class SIMCard(observable.Device):
    """
...
class RasterPicture(observable.File):
    """
    A raster picture is a raster (or bitmap) image.
    """


class Code(observable.ObservableObject):
    """
...
class UserAccount(observable.DigitalAccount):
    """
...
class NetworkAppliance(observable.Appliance):
    """
...
class Laptop(observable.Computer):
    """
...
class ICMPConnection(observable.NetworkConnection):
    """
...
class Call(observable.ObservableObject):
    """
...
class AlternateDataStream(observable.ObservableObject):
    """
...
class Audio(observable.ObservableObject):
    """
...
class Server(observable.Computer):
    """
...
class EventLog(observable.ObservableObject):
    """
    An event log is a collection of event records.
    """


class BrowserCookie(observable.ObservableObject):
    """
...
class DNSCache(observable.ObservableObject):
    """
...
class FileSystemObject(observable.ObservableObject):
    """
...
class WikiArticle(observable.ObservableObject):
    """
...
class Drone(observable.MobileDevice):
    """
...
class NetworkSubnet(observable.ObservableObject):
    """
...
class ValuesEnumeratedEffectFacet(observable.DefinedEffectFacet):
    """
...
class SmartPhone(observable.Computer):
    """
...
class WhoIs(observable.ObservableObject):
    """
...
class WearableDevice(observable.SmartDevice):
    """
...
class WindowsActiveDirectoryAccount(observable.DigitalAccount):
    """
...
class ApplicationAccount(observable.DigitalAccount):
    """
...
class IPv6Address(observable.IPAddress):
    """
...
class Mutex(observable.ObservableObject):
    """
...
class Semaphore(observable.ObservableObject):
    """
...
class Credential(observable.ObservableObject):
    """
...
class WindowsSystemRestore(observable.ObservableObject):
    """
...
class WirelessNetworkConnection(observable.NetworkConnection):
    """
...
class MobileAccount(observable.DigitalAccount):
    """
...
class CredentialDump(observable.ObservableObject):
    """
...
class GeoLocationTrack(observable.ObservableObject):
    """
...
class Process(observable.ObservableObject):
    """
...
class ReparsePoint(observable.FileSystemObject):
    """
...
class PhoneAccount(observable.DigitalAccount):
    """
...
class WifiAddressFacet(observable.MACAddressFacet):
    """
...
class Wiki(observable.ObservableObject):
    """
...
class BlockDeviceNode(observable.FileSystemObject):
    """
...
class IPv6AddressFacet(observable.IPAddressFacet):
    """
...
class CookieHistory(observable.ObservableObject):
    """
...
class URL(observable.ObservableObject):
    """
...
class Software(observable.ObservableObject):
    """
...
class ARPCacheEntry(observable.ObservableObject):
    """
...
class SecurityAppliance(observable.Appliance):
    """
...
class Device(observable.ObservableObject):
    """
...
class DigitalCamera(observable.Device):
    """
...
class MACAddressFacet(observable.DigitalAddressFacet):
    """
...
class ProcessThread(observable.ObservableObject):
    """
...
class CapturedTelecommunicationsInformation(observable.ObservableObject):
...
class URLHistory(observable.ObservableObject):
    """
...
class WebPage(observable.ObservableObject):
    """
...
class IPv4AddressFacet(observable.IPAddressFacet):
    """
...
class GamingConsole(observable.Device):
    """
...
class WindowsMailslot(observable.ObservableObject):
    """
...
class AndroidDevice(observable.Device):
    """
...
class DiskPartition(observable.ObservableObject):
    """
...
class MobileDevice(observable.Device):
    """
...
class NTFSFile(observable.File):
    """
    An NTFS file is a New Technology File System (NTFS) file.
    """


class IPNetmask(observable.ObservableObject):
    """
...
class BluetoothAddress(observable.MACAddress):
    """
...
class WindowsPrefetch(observable.ObservableObject):
    """
...
class StorageMedium(observable.Device):
    """
...
class Adaptor(observable.Device):
    """
...
class OperatingSystem(observable.ObservableObject):
    """
...
class Note(observable.ObservableObject):
    """
    A note is a brief textual record.
    """


class WindowsEvent(observable.ObservableObject):
    """
...
class ConfiguredSoftware(observable.Software):
    """
...
class PropertyReadEffectFacet(observable.DefinedEffectFacet):
    """
...
class Profile(observable.ObservableObject):
    """
...
class IPAddressFacet(observable.DigitalAddressFacet):
    """
...
class Address(observable.ObservableObject):
    """
...
class SIPAddress(observable.DigitalAddress):
    """
...
class CellSite(observable.ObservableObject):


class SMSMessage(observable.Message):
    """
...
class EmailMessage(observable.Message):
    """
...
class FileSystem(observable.ObservableObject):
    """
...
class SocketAddress(observable.Address):
    """
...
class CharacterDeviceNode(observable.FileSystemObject):
    """
...
class URLVisit(observable.ObservableObject):
    """
...
class AndroidPhone(observable.AndroidDevice):
    """
...
class Message(observable.ObservableObject):
    """
...
class PaymentCard(observable.ObservableObject):
    """
...
class IPAddress(observable.DigitalAddress):
    """
...
class WifiAddress(observable.MACAddress):
    """
...
class WindowsFilemapping(observable.ObservableObject):
    """
...
class GenericObservableObject(observable.ObservableObject):
    """
    A generic observable object is an article or unit within the digital domain.
    """


class Hostname(observable.ObservableObject):
    """
...
class SmartDevice(observable.Device):
    """
...
class EmbeddedDevice(observable.Device):
    """
...
class HTTPConnection(observable.NetworkConnection):
    """
...
class UNIXProcess(observable.Process):
    """
...
class UserSession(observable.ObservableObject):
    """
...
class WindowsAccount(observable.DigitalAccount):
    """
    A Windows account is a user account on a Windows operating system.
    """


class Socket(observable.FileSystemObject):
    """
...
class InstantMessagingAddress(observable.DigitalAddress):
...
class Memory(observable.ObservableObject):
    """
...
class Computer(observable.Device):
    """
...
class Contact(observable.ObservableObject):
    """
...
class WriteBlocker(observable.Device):
    """
...
class WindowsProcess(observable.Process):
    """
...
class BrowserBookmark(observable.ObservableObject):
    """
...
class File(observable.FileSystemObject):
    """
...
class DigitalSignatureInfo(observable.ObservableObject):
    """
...
class NamedPipe(observable.FileSystemObject):
    """
...
class MessageThreadFacet(core.Facet):
    ...
    n5ebc1febb0674ef188f70389706031c3b463: Optional[Message] = None
    n5ebc1febb0674ef188f70389706031c3b467: Optional[Message] = None
    n5ebc1febb0674ef188f70389706031c3b471: Optional[Message] = None
    n5ebc1febb0674ef188f70389706031c3b475: Optional[Message] = None
    participant: Optional[ObservableObject] = None
...
class AppleDevice(observable.Device):
    """
...
class Account(observable.ObservableObject):
    """
...
class Volume(observable.ObservableObject):
    """
...
class CalendarEntry(observable.ObservableObject):
    """
...
class WindowsRegistryKey(observable.ObservableObject):
    """
...
class WindowsNetworkShare(observable.ObservableObject):
    """
...
class Junction(observable.FileSystemObject):
    """
...
class BotConfiguration(observable.ObservableObject):
    """
...
class NetworkInterface(observable.ObservableObject):
    """
...
class DigitalAddress(observable.Address):
    """
...
class AutonomousSystem(observable.ObservableObject):
    """
...
class ShopListing(observable.ObservableObject):
    """
...
class DNSRecord(observable.ObservableObject):
    """
...
class NetworkConnection(observable.ObservableObject):
    """
...
class GeoLocationEntry(observable.ObservableObject):
    """
    A geolocation entry is a single application-specific geolocation entry.
    """


class WindowsComputerSpecification(observable.ObservableObject):
    """
...
class Tablet(observable.Computer):
    """
...
class IPv4Address(observable.IPAddress):
    """
...
class GeoLocationLog(observable.ObservableObject):
    """
...
class NetworkProtocol(observable.ObservableObject):
    """
...
class TCPConnection(observable.NetworkConnection):
    """
    A TCP connection is a network connection that is conformant to the Transfer
    """


class WindowsRegistryHive(observable.ObservableObject):
    """
...
class WindowsPEBinaryFile(observable.File):
    """
...
class Calendar(observable.ObservableObject):
    """
...
class ForumPost(observable.Message):
    """
...
class ARPCache(observable.ObservableObject):
    """
...
class OnlineService(observable.ObservableObject):
    """
...
class SymbolicLink(observable.FileSystemObject):
    """
...
class MobilePhone(observable.MobileDevice):
    """
...
class Snapshot(observable.FileSystemObject):
    """
