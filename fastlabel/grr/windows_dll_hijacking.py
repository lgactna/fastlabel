"""
Auto-generated classes from the YAML declarations in windows_dll_hijacking.yaml.
...
class DLLHijackLocations(GRRArtifactBase):
    """
    DLL search order hijacking locations collected from base Windows 7.
