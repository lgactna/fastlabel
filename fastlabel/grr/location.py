...
class GPSCoordinatesFacet(Facet):
    ...
    geolocation coordinates typically associated with satellite navigation such as
...
class LatLongCoordinatesFacet(Facet):
    ...
    expression of a geolocation as the intersection of specific latitude, longitude,
    and altitude values.
    """
...
class SimpleAddressFacet(Facet):
    """
    A simple address facet is a grouping of characteristics unique to a geolocation
